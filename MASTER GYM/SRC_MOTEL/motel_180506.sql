...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 06, 2018 lúc 09:01 AM
...
(2, 'vietnv', 'vietnv', 3, NULL, 1, NULL, NULL);
...
(3, 'Lê Thị Bé', 2, NULL, '', '0123456789', 1, '', 'gai', '', NULL, '', NULL, 1, NULL, '', 'học sinh');
...
--
ALTER TABLE `bill_service`
  MODIFY `BILL_SERVICE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `electric_water`
  MODIFY `electric_water_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `function_path`
--
ALTER TABLE `function_path`
  MODIFY `FUNCTION_PATH_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `log_action`
  MODIFY `LOG_ACTION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
