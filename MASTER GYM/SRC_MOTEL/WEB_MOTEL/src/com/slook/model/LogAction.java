...
public class LogAction {
	...
	public String getActionTypeName() {
		if(Constant.LOG_ACTION.INSERT.equals(actionType))actionTypeName="Insert";
		else if(Constant.LOG_ACTION.UPDATE.equals(actionType))actionTypeName="Update";
		else if(Constant.LOG_ACTION.DELETE.equals(actionType))actionTypeName="Delete";
		else if(Constant.LOG_ACTION.IMPORT.equals(actionType))actionTypeName="Import";
