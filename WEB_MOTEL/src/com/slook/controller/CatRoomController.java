...
public class CatRoomController implements Serializable
{
    ...
    public void saveOrUpdate()
    {
        try
        {
            if (currRoom.getCatMachine() != null)
            {
                currRoom.setMachineId(currRoom.getCatMachine().getMachineId());
            }
            if (currRoom.getCatMachineOut() != null)
            {
                currRoom.setMachineOutId(currRoom.getCatMachineOut().getMachineId());
            }
