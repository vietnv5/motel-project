...
public class CatJobTitle
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (jobTitleId != null ? !jobTitleId.equals(that.jobTitleId) : that.jobTitleId != null)
        {
            return false;
        }
        if (jobTitleCode != null ? !jobTitleCode.equals(that.jobTitleCode) : that.jobTitleCode != null)
        {
            return false;
        }
        if (jobTitleName != null ? !jobTitleName.equals(that.jobTitleName) : that.jobTitleName != null)
        {
            return false;
        }
