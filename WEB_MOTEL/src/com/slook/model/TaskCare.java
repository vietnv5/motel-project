...
public class TaskCare
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (taskCareId != null ? !taskCareId.equals(taskCare.taskCareId) : taskCare.taskCareId != null)
        {
            return false;
        }
        if (employeeId != null ? !employeeId.equals(taskCare.employeeId) : taskCare.employeeId != null)
        {
            return false;
        }
        if (type != null ? !type.equals(taskCare.type) : taskCare.type != null)
        {
            return false;
        }
        if (name != null ? !name.equals(taskCare.name) : taskCare.name != null)
        {
            return false;
        }
