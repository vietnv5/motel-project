...
public class CatCommune
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (communeCode != null ? !communeCode.equals(that.communeCode) : that.communeCode != null)
        {
            return false;
        }
        if (communeName != null ? !communeName.equals(that.communeName) : that.communeName != null)
        {
            return false;
        }
